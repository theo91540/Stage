...
public class Rendering extends Composant
{
	...
	public String toXML(Systeme sys)
	{
		...
		codexml += "<transition><source ref=\""+init+"\"/><target ref=\""+(init+1)+"\"/><label kind=\"synchronisation\" x=\"50\" y=\"-20\">lock_"+this.getSource()[0]+"!</label><label kind=\"assignment\" x=\"50\" y=\"10\">x=0</label></transition>\n";
		codexml += "<transition><source ref=\""+(init+1)+"\"/><target ref=\""+(init+2)+"\"/><label kind=\"guard\" x=\"200\" y=\"-20\">x&gt;="+this.getMin()[0]+"</label></transition>\n";
		codexml += "<transition><source ref=\""+(init+2)+"\"/><target ref=\""+(init+3)+"\"/><label kind=\"synchronisation\" x=\"350\" y=\"-20\">unlock_"+this.getSource()[0]+"!</label><label kind=\"assignment\" x=\"350\" y=\"10\">x=0</label></transition>\n";
